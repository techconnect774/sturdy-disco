...
export function AdminLayout({ children }: AdminLayoutProps) {
  ...
  const navLinks = [
    { path: '/admin', label: 'Articles', icon: 'articles' },
    { path: '/admin/comments', label: 'Comments', icon: 'comments' }
  ];
        ...
        <div className="flex min-h-0 flex-1 flex-col bg-gradient-to-b from-white to-gray-50 dark:from-gray-800 dark:to-gray-900 border-r border-gray-200 dark:border-gray-700 shadow-lg">
          <div className="flex flex-1 flex-col overflow-y-auto pt-6 pb-4">
            ...
            <nav className="mt-8 flex-1 space-y-2 px-3">
              ...
              <Link
                to="/"
                className="group flex items-center px-3 py-3 text-sm font-medium rounded-lg transition-all text-green-600 dark:text-green-400 hover:bg-green-50 dark:hover:bg-green-900/20 border border-green-200 dark:border-green-800 mb-4"
              >
          ...
          <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 shadow-lg">
            <nav className="px-3 pt-3 pb-3 space-y-2">
              ...
              <Link
                ...
                className="flex items-center px-3 py-3 rounded-lg text-base font-medium transition-all text-green-600 dark:text-green-400 hover:bg-green-50 dark:hover:bg-green-900/20 border border-green-200 dark:border-green-800"
              >
                <svg className="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
                </svg>
